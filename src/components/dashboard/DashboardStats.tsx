...
export default function DashboardStats() {
   ...
   if (loading) {
      return (
         ...
         >
            <StatCard title="Latest Vent" content="Loading..." />
            <StatCard title="Latest Reflection" content="Loading..." />
            <StatCard title="Last Delivered Message" content="Loading..." />
         </motion.section>
      );
   }
   ...
   return (
      ...
      >
         ...
         <StatCard
            ...
            content={latestReflection?.content || "No reflections written yet."}
